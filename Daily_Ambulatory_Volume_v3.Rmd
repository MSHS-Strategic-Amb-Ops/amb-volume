...
total_encounters_comp <- as.character(ifelse(total_encounters_comp >0, 
                                paste0(total_encounters_comp, " increase from ",full_month," ", full_year),
                                paste0(total_encounters_comp, " decrease from ",full_month," ", full_year)))
...
total_in_person <- as.character(ifelse(total_in_person >0, 
                                paste0(" increased by ",total_in_person," from ", full_month," ", full_year),
                                paste0(" decreased by ",total_in_person," from ", full_month," ", full_year)))
