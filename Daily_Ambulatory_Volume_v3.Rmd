...
vol_takeaways_function <- function(site){
  # site <- "MSH-MSDFP"
    ...
    total_encounters_comp_site <- as.character(ifelse(total_encounters_comp_site >0, 
                                             paste0(total_encounters_comp_site, " increase from ",full_month," ", last_year),
                                             paste0(total_encounters_comp_site, " decrease from ",full_month," ", last_year)))
    ...
    total_in_person_site <- as.character(ifelse(total_in_person_site >0, 
                                       paste0(" increased by ",total_in_person_site," from ", full_month," ", last_year),
                                       paste0(" decreased by ",total_in_person_site," from ", full_month," ", last_year)))
